...
spark = SparkSession.builder.appName("Hospital1MySQLToLanding").getOrCreate()
...
# MySQL Configuration
MYSQL_CONFIG = {
    "url": "jdbc:mysql://34.63.172.197:3306/supreme_hosp1_db",
...
def get_latest_watermark(table_name):
    query = f"""
        ...
        FROM `{BQ_AUDIT_TABLE}`
        WHERE tablename = '{table_name}' and data_source = "supreme_hosp1_db"
    """
...
#                 .option("url", "jdbc:mysql://34.63.172.197:3306/supreme_hosp1_db")

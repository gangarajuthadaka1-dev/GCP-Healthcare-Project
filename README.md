...
Tracks historical changes in dimension tables (e.g., patient details changes, transactions information updates). 
...
As data engineers, we manage data from various sources and create ETL pipelines that transform raw data into structured tables in data lake for reporting and dashboard generation. 
...
Public API providing standardized system to describe medical, surgical, and diagnostic procedures. 
...
4.Orchestration: 
Orchestrating the all the jobs for dependency and order 
